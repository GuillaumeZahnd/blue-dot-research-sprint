...
if __name__ == "__main__":
    ...
    if target_model == "BASELINE":
        ...
        target_model_path = Parameters.PATH_TO_MODELS / Parameters.MODEL_NAME_BASELINE
        ...
        target_model_path = Parameters.PATH_TO_MODELS / Parameters.MODEL_NAME_TAR
    ...
    # Just save the model adapter (will need the base model when loading)
